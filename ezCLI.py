...
# ==============================================================================
# noinspection PyBroadException,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
def convert(string):
  ...
  """
    try:
        string = eval(string)  # check if 'eval' can be applied on 'string'
    except Exception:
        pass  # keep 'string' unchanged if 'eval' fails
    return string


# ------------------------------------------------------------------------------
# noinspection PyUnresolvedReferences,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
def parse(string, default='', vsep=' ', nsep='='):
  ...
  """
    ...
    # ------------------------------------------------------------------------------
    # noinspection PyShadowingNames,PyShadowingNames,PyShadowingNames,PyShadowingNames,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
    def splitstring(string, vsep, nsep):
        ...
        for n, c in enumerate(code):
            if c == "'" and state in (0, 1):
                state = 1 - state  # enter/leave '' string
            elif c == '"' and state in (0, 2):
                state = 2 - state  # enter/leave "" string
            elif c in enter and not state:
                stack.append(c)  # enter bracket zone
        ...
        if not dic['']:
            del dic['']  # remove key for non-named values if empty
        else:
            dic[''] = tuple(dic[''])  # store non-named values as tuple
    ...
    if default:  # a string or a dictionary of default values is provided
        ...
        if '' in diff:
            raise ValueError("only named values are allowed here")
        elif len(diff):
            raise NameError("unallowed names %r" % ','.join(diff))
...
# ------------------------------------------------------------------------------
# noinspection PyTypeChecker,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
def grid(matrix, inner=True, outer=True, label=False, size=None):
  ...
  """
    ...
    if size is None:
        size = width  # default size when no user-provided size
    elif width > size:
        width = size  # all cells will be truncated to 'size'
...
# ==============================================================================
# noinspection PyRedundantParentheses,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
...
"""
    ...
    for stop in stops:  # iterate over slices from 'args'
        print(*args[slice(start, stop)], sep=sep, end=end);
        start = stop + 1
...
# ------------------------------------------------------------------------------
# noinspection PyRedundantParentheses,PyUnusedLocal,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
def userloop(process=None, prompt=None, hello=None, bye=None,
  ...
  """
    ...
    while (n):  # do 'n' iterations at most (infinite loop by default)
        ...
        try:
            output = process(command); print(output, end='\n' if output else '')
        except Exception as e:
            print("%s: %s" % (e.__class__.__name__, e)); n += 1
    if bye: frame(bye)
...
# ==============================================================================
# noinspection PyTrailingSemicolon,PyUnboundLocalVariable,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
def timer(fcall, show=True, n=1000):
  ...
  """
    ...
    fcall = fcall.strip();
    p, q = fcall.find('('), fcall.rfind(')')
    name, args = fcall[:p], '[' + fcall[p + 1:q] + ']'
    try:  # check if 'f(*args)' is valid in namespace from caller function
        f = eval(name, namespace);
        args = eval(args, namespace);
        f(*args)
    except TypeError:  # if 'TypeError', try again by adding indirection to 'args'
        try:
            args = [args]; f(*args)
        except Exception:
            raise RuntimeError("incorrect function call %r" % fcall)
    except Exception:
        raise RuntimeError("incorrect function call %r" % fcall)
    chrono = time();
    print("..TIMER IS RUNNING.." * 4)
    for p in range(n): f(*args)
    chrono -= time();
    fcall = '%s(%s)' % (name, str(args)[1:-1]);
    if not show: return abs(chrono)
    pause("Timing for %s = %.3g sec (%s calls)" % (fcall, abs(chrono), n))


# ------------------------------------------------------------------------------
# noinspection PyUnresolvedReferences,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
def inspect(names=False, show=True, wrap=True, field=80):
  ...
  """
    ...
    split = lambda val: pformat(val, width=rsize).replace('\n', offset)
...
# ------------------------------------------------------------------------------
# noinspection PyTypeChecker,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
def testcode(code, wrap=True, field=80):
  ...
  """
    ...
    # ------------------------------------------------------------------------------
    # noinspection PyShadowingNames,PyShadowingNames,PyShadowingNames,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
    def splitcode(code):
        ...
        for n, c in enumerate(code):
            if c == '\n' and state in (0, 3):
                state = 0; code[n] = chr(0)  # newline
            elif c == "'" and state in (0, 1):
                state = 1 - state  # enter/leave '' string
            elif c == '"' and state in (0, 2):
                state = 2 - state  # enter/leave "" string
            elif c == '#' and state == 0:
                state = 3  # enter comment
    ...
    # ------------------------------------------------------------------------------
    # noinspection PyShadowingNames,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
    def evalexec(statement, namespace):
        """eval/exec 'statement', according to names and values in 'namespace'"""
        try:
            return 1, eval(statement, namespace)
        except SyntaxError:
            try:
                return 0, exec(statement, namespace)
            except Exception as e:
    ...
    for line in splitcode(code):
        if line:  # non-empty lines in 'code' are either statements or comments
            ...
            break  # break loop if user interruption


# ==============================================================================
# File manipulation tools : read_[txt|blk|csv|ini], write_[txt|blk|csv|ini]
# ==============================================================================
# noinspection PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
...
# ------------------------------------------------------------------------------
# noinspection PyTypeChecker,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
...
# ------------------------------------------------------------------------------
# noinspection PyShadowingNames,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
    ...
    for block in string.split(sep):  # look over blocks found in file content
        for key in filters:  # loop over registered prefix strings
            if key and filters[key] and block.startswith(key):
                block = filters[key](block);
                break  # apply corresponding block filter
...
def read_csv(filename, raw=False, colsep=',', rowsep='\n', sep='\n\n'):
  ...
  """
    ...
    # ----------------------------------------------------------------------------
    # noinspection PyShadowingNames,PyShadowingNames,PyShadowingNames,PyShadowingNames,PyPep8,PyPep8
...
# ------------------------------------------------------------------------------
# noinspection PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
  ...
  """
    ...
    if single(matrix):  # whole matrix is one single data = 0D matrix
        ...
        matrix = [str(blk) if single(blk) else rowsep.join(str(row) if single(row) \
                                                               else colsep.join(map(str, row)) for row in blk) for blk
                  in matrix]
...
# ------------------------------------------------------------------------------
# noinspection PyUnusedLocal,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8
  ...
  """
    ...
    for lhand, rhand in read_blk(filename, filters=filters) + [('', '')]:
        if lhand == ':':  # section line
            ...
            section, name, value = rhand.strip(), '', '';
            items[section] = {}
    ...
    if len(items) == 1:
        items = items['']  # remove sections if only one section
    elif not items['']:
        del items['']  # remove default section if empty
    return items
...
def write_ini(filename, items, start=None, stop=0, step=1, sep='\n'):
  ...
  """
    ...
    if isinstance(items, dict):
        ...
        items = '\n'.join(("\n[%s]\n" % sect if sect else '') + '\n'.join("%s = %s"
                                                                          % (n, v) for n, v in order(prop)) for
                          sect, prop in order(items))
    else:
        items = str(items)
